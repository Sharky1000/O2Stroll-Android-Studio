...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  private FragmentSplashBinding(@NonNull ConstraintLayout rootView, @NonNull TextView appLogo,
      @NonNull TextView appName, @NonNull TextView appTagline) {
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSplashBinding((ConstraintLayout) rootView, appLogo, appName, appTagline);
    }
